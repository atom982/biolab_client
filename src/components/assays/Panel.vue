        ...
        <div class="form-group">
          <div class="input-group">
            <input
              ...
              required
            >
            <label class="control-label" for="simple-input">{{'Šifra panela'}}</label>
            <i class="bar"></i>
          </div>
        </div>
        ...
        <div class="form-group">
          <div class="input-group">
            ...
            <!--  <input
              ...
              required
            >-->
            <label class="control-label" for="simple-input">{{'Naziv panela'}}</label>
            <i class="bar"></i>
          </div>
        </div>
        <div class="form-group">
          <div class="input-group">
            ...
            <!--  <input
              ...
              required
            >-->
            <label class="control-label" for="simple-input">{{'Opis panela'}}</label>
            <i class="bar"></i>
          </div>
        </div>
