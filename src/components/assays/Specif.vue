    ...
    <div class="row">
        ...
        <div class="form-group">
          <div class="input-group">
            <input
              ...
              required
            >
            <label class="control-label" for="simple-input">{{'Šifra specifične analize'}}</label>
            <i class="bar"></i>
          </div>
        </div>
        ...
        <div class="form-group">
          <div class="input-group">
            ...
            <!-- <input
              ...
              required
            >-->
            <label class="control-label" for="simple-input">{{'Naziv specifične analize'}}</label>
            <i class="bar"></i>
          </div>
        </div>
        <div class="form-group">
          <div class="input-group">
            ...
            <!-- <input
              ...
              required
            >-->
            <label class="control-label" for="simple-input">{{'Opis specifične analize'}}</label>
            <i class="bar"></i>
          </div>
        </div>
      ...
      <div class="col-md-4">
        <div class="vuestic-page-not-found-search">
          <div class="vuestic-page-not-found-search__content">
            <div class="vuestic-page-not-found-search__wallpaper col-md-12"></div>
      ...
      <div class="col-md-4">
        <div
          ...
          :style="{'grid-template-columns': 'repeat(1, 1fr)'}"
        >
          <ul class="vuestic-page-not-found-search__list" style="color: #4ae387;">
            <li
              class="vuestic-page-not-found-search__list-element"
...
export default {
  ...
  mounted() {
    bus.$on("Specifične analize", data => {
      this.Reset();
    });
  },
  ...
  methods: {
    ...
    Check() {
      ...
      if (uslov) {
        // "kategorija" : "Specifične | GLUK profil (0, 120) | Profil glukoze (0, 120)",
        this.kategorija =
