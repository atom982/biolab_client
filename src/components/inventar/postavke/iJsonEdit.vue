    ...
    EditJson() {
      switch (this.tab) {
        ...
        case "Vrsta ugovora":
          ...
          case "Proizvođači":
          http
            .post("inventar/editproizvodjac", {
              proizvodjac: this.obj,
              token: this.$store.state.token,
              site: this.$store.state.site
            })
            .then(res => {
