...
export default {
  name: "mikrobiologija-edit-modal",
  props: {
    transition: {
      type: String,
      default: "modal"
  ...
  mounted() {
    bus.$on("MikrobiologijaModalHide", () => {
      this.show = false;
    });
  },
  beforeDestroy() {
    bus.$off("MikrobiologijaModalHide");
  },
  computed: {
    modalClass() {
      return {
  ...
  methods: {
    ...
    ok() {
      ...
      switch (this.edit_data) {
        case "analiza":
          ...
          bus.$emit("MikrobiologijaModalEditAnalize", disable_close);
          break;
        case "bakterija":
          bus.$emit("MikrobiologijaModalEditBakterije");
          break;
        case "antibiogram":
          bus.$emit("MikrobiologijaModalEditAntibiogrami");
          break;
        case "antibiotik":
          bus.$emit("MikrobiologijaModalEditAntibiotici");
          break;

        default:
          this.show = false;
          console.warn("Source Unknown.");
          break;
      }
    ...
    cancel() {
      ...
      switch (this.edit_data) {
        case "analiza":
          bus.$emit("MikrobiologijaModalCancelAnalize");
          break;
        case "bakterija":
          bus.$emit("MikrobiologijaModalCancelBakterije");
          break;
        case "antibiogram":
          bus.$emit("MikrobiologijaModalCancelAntibiogrami");
          break;
        case "antibiotik":
          bus.$emit("MikrobiologijaModalCancelAntibiotici");
          break;
