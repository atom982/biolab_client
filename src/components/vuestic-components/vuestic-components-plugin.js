...
import SitesDataModal from "src/components/statistika/SitesDataModal.vue";
...
import VuesticModalPatientsData from "src/components/statistika/VuesticModalPatientsData.vue";
...
const VuesticComponentsPlugin = {
  install(Vue, options) {
    ...
    Vue.component(SitesDataModal.name, SitesDataModal);
